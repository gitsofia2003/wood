...
const CategoryIcon = ({ type }) => {
    ...
    const icons = {
        ...
        Dresser: {
            viewBox: "0 0 256 256", 
            content: <path fill="currentColor" d="M144 192a8 8 0 0 1-8 8h-16a8 8 0 0 1 0-16h16a8 8 0 0 1 8 8M120 72h16a8 8 0 0 0 0-16h-16a8 8 0 0 0 0 16m16 48h-16a8 8 0 0 0 0 16h16a8 8 0 0 0 0-16m80-80v176a16 16 0 0 1-16 16H56a16 16 0 0 1-16-16V40a16 16 0 0 1 16-16h144a16 16 0 0 1 16 16M56 152h144v-48H56Zm0-112v48h144V40Zm144 176v-48H56v48z"/>
        },
        DresserOutline: {
            viewBox: "0 0 24 24",
            content: <path fill="currentColor" d="M4 3c-1.1 0-2 .9-2 2v13a2 2 0 0 0 2 2v1h2v-1h12v1h2v-1c1.11 0 2-.89 2-2V5a2 2 0 0 0-2-2zm0 2h16v3H4zm6 1v1h4V6zm-6 4h16v3H4zm6 1v1h4v-1zm-6 4h16v3H4zm6 1v1h4v-1z"/>
        },
        DeskSitAlt: {
            viewBox: "0 0 24 24",
            content: <path fill="currentColor" d="M15.91 5.938L1.17 7.808l-.009.236l8.082 2.46l13.348-2.876l.006-.201Zm5.737 1.967l-1.646.365s.063.132.236.194c.174.061 1.464-.28 1.46-.403c-.005-.123-.05-.156-.05-.156m-2.212.483l-.532.134l-.111 5.223v.002l-.002.002l-.004.002h-.004l-.053.002c-.005 0-.01-.003-.01-.006l.112-5.213l-.531.092l-.07 5.096l.517.146l.594-.164zm-14.528.927l-.01 5.8l.577.22l.777-.153l-.008-5.49l-.726-.084l.003 5.596c0 .003-.004.006-.01.006l-.052-.004c-.006 0-.01-.003-.01-.006l-.031-5.605Zm11.002 4.399c-.105-.014-.818.191-.818.191s-.037.014-.047.033c-.02.038-.012.196-.012.196l6.955 1.804s.111.034.223.032c.163-.004.588-.163.588-.163s.04-.001.04-.082c-.004-.065-.18-.279-.403-.357c-.05-.016-3.194-.81-3.194-.81l.004-.69l-.5.139l-.451-.135l-.01.455s-2.27-.6-2.375-.613M3.218 14.966c-.072-.012-.933.12-.996.156c-.04.022-.045.228-.045.228l6.054 2.676s.096.063.32.022c.225-.042.7-.164.7-.164s.212-.07.111-.211c-.1-.142-.412-.399-.412-.399l-2.84-1.172l-.004-.765l-.673.138l-.436-.187l.01.371s-1.707-.68-1.79-.693"/>
        },
        Desk16Regular: {
            viewBox: "0 0 16 16",
            content: <path fill="currentColor" d="M2.75 3A1.75 1.75 0 0 0 1 4.75v6.5c0 .966.784 1.75 1.75 1.75h3.5A1.75 1.75 0 0 0 8 11.25V7h6v5.5a.5.5 0 0 0 1 0V4.75A1.75 1.75 0 0 0 13.25 3zM2 7h5v4.25a.75.75 0 0 1-.75.75h-3.5a.75.75 0 0 1-.75-.75zm0-1V4.75A.75.75 0 0 1 2.75 4h10.5a.75.75 0 0 1 .75.75V6zm1.5 2a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1z"/>
        },
        Desk: {
            viewBox: "0 0 24 24",
            content: <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 6h18M4 6v13m16 0V6M4 10h16m-5-4v8a2 2 0 0 0 2 2h3"/>
        },
        DeskDuotone: {
            viewBox: "0 0 256 256",
            content: (
                <>
                    <path d="M232 72v64H24V72Z" opacity=".2"/>
